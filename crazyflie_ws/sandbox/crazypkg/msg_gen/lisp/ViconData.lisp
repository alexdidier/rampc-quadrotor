...
(cl:defclass <ViconData> (roslisp-msg-protocol:ros-message)
  ((x
   ...
   (yaw
    ...
    :initform 0.0)
   (acquiringTime
    :reader acquiringTime
    :initarg :acquiringTime
    :type cl:float
    :initform 0.0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ViconData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ViconData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazypkg-msg:<ViconData> is deprecated: use crazypkg-msg:ViconData instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ViconData>))
...
(cl:defmethod y-val ((m <ViconData>))
...
(cl:defmethod z-val ((m <ViconData>))
...
(cl:defmethod roll-val ((m <ViconData>))
...
(cl:defmethod pitch-val ((m <ViconData>))
...
(cl:defmethod yaw-val ((m <ViconData>))
...
(cl:ensure-generic-function 'acquiringTime-val :lambda-list '(m))
(cl:defmethod acquiringTime-val ((m <ViconData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazypkg-msg:acquiringTime-val is deprecated.  Use crazypkg-msg:acquiringTime instead.")
  (acquiringTime m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ViconData>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'yaw))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'acquiringTime))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ViconData>) istream)
  "Deserializes a message object of type '<ViconData>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'acquiringTime) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ViconData>)))
  ...
  "3aaa54bd6680c6a9bcb78b73c5685d64")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ViconData)))
  "Returns md5sum for a message object of type 'ViconData"
  "3aaa54bd6680c6a9bcb78b73c5685d64")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ViconData>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%float64 acquiringTime~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ViconData)))
  "Returns full string definition for message of type 'ViconData"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%float64 acquiringTime~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ViconData>))
  ...
  (cl:list 'ViconData
    ...
    (cl:cons ':yaw (yaw msg))
    (cl:cons ':acquiringTime (acquiringTime msg))
))
