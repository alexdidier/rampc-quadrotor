...
(cl:defmethod cl:initialize-instance :after ((m <ControllerOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControllerOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazypkg-msg:<ControllerOutput> is deprecated: use crazypkg-msg:ControllerOutput instead.")))
...
(cl:defmethod pitch-val ((m <ControllerOutput>))
...
(cl:defmethod motorCmd1-val ((m <ControllerOutput>))
...
(cl:defmethod motorCmd2-val ((m <ControllerOutput>))
...
(cl:defmethod motorCmd3-val ((m <ControllerOutput>))
...
(cl:defmethod motorCmd4-val ((m <ControllerOutput>))
...
(cl:defmethod onboardControllerType-val ((m <ControllerOutput>))
